...
import server.TranslationRequest;
import javax.swing.JTextField;

/**
 * This class will display the GUI in client part 
 * and display targeted language and the word
 * and display back translated language
 * @author norbalqish
 *
 */
public class ClientFrame extends JFrame {
    ...
    public ClientFrame() {
        ...
        languageDropdown.addItem("Korean");
        languageDropdown.addItem("Arabic");
    ...
    private JButton createTranslateButton() {
        ...
        btnTranslate.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                TranslationRequest.translate(text, targetLanguage);
            }
        });
        return btnTranslate;
    }
    ...
    /**
     * This method request text entered in the request text field.
     *
    ...
    /**
     * This method will return selected language from the dropdown.
     *
