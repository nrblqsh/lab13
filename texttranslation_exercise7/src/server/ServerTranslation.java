 ...
 * The server translate word from the client 
 * The server calculate sum of request
 *  client will received translated word from the server.
 * @author norbalqish
 *
 */
...
public class ServerTranslation {
	...
	public static void main(String[] args) throws IOException {
		...
		while (true) {
			...
			String translatedWord = TranslationRequest.translate(input,targetLanguage);
			...
			serverFrame.updateRequestStatus("Client has been "
					+ "connected. Total request = " + ++totalRequest );
